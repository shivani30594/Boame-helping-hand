...
<div class="row">
  <div class="col-sm-12">
      <form class="form-horizontal" data-validate="parsley" method="post" enctype="multipart/form-data" action="<?php echo BASE_URL;?>admin/testimonial/<?php echo isset($edit) ? 'edit_testimonial' : 'add_testimonial'?>" id="edit_news_form">
        <input type="hidden" class="form-control parsley-validated" name="user_id" value="<?php echo isset($testimonial) ?  $testimonial->user_id : '';?>">
        ...
        <section class="panel panel-default">
          ...
          <div class="panel-body">                    
            <div class="form-group">
              ...
              <div class="col-sm-9">
                <input type="text" class="form-control parsley-validated" name="full_name" data-type="text" data-required="true" placeholder="Full Name" value="<?php echo isset($testimonial) ?  $testimonial->full_name : '' ?>">    
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-9">
                  ...
                  <option value="in_progress" <?php echo $testimonial->status == 'in_progress' ? 'selected' : ''?>>In Progress</option>
                  <option value="deleted" <?php echo $testimonial->status == 'deleted' ? 'selected' : ''?>>Cancel</option>
                  </select>
              </div>
            </div>
            <div class="line line-dashed b-b line-lg pull-in"></div>
            <div class="form-group">
              ...
              <div class="col-sm-9">
                ...
                <div>
                    <?php if (isset($edit)) : ?>
                      <img src="<?php echo ADMIN_TESTIMONIALS. $testimonial->image ?>" alt="" class="img-responsive img-thumbnail" height="300px" width="300px">
                    <?php endif;?>    
                </div>
              </div>
            </div>
