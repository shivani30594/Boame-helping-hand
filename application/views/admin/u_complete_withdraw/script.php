<script>
    ...
    {
       table = $('#usd_withdrawal_request').DataTable({
            "bStateSave": true,
            ...
            "ajax":{
             "url": "<?php echo BASE_URL?>admin/withdraw/u_complete_indexjson",
             "dataType": "json",
             "type": "POST",
             "data":{  '<?php echo $this->security->get_csrf_token_name(); ?>' : '<?php echo $this->security->get_csrf_hash(); ?>' }
                ...
                "columnDefs": [ {
                    ...
                    "render": function ( data, type, row, meta ) {
                      ...
                      return '<a class="btn btn-sm btn-icon btn-danger " '+style+' id="delete_btn" data-withdrawid='+row.id+' data-toggle="tooltip" title="Cancel Request"><i class="fa fa-close"></i></a>';
                    }
                } ] ,
