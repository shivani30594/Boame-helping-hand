        ...
        <form method="post" name="login_form" id="login_form">
          ...
          <div class="right-form">
            <div class="list-group">
              ...
              <div class="list-group-item">
                <input type="password" placeholder="Password" class="form-control no-border" name="confirm_password" id="confirm_password">
              </div>
            </div>
            <button type="submit" name="submit" value="submit"  class="btn btn-lg btn-primary btn-block">Change Password</button>
            <div class="line line-dashed"></div>
            <p class="text-muted text-center"><small>Remember Password? </small><a href="<?php echo BASE_URL?>user/signin" class="">Sign In</a></p>
          </div>
        </form>
      </section>
    </div>
