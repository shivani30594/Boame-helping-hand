        ...
        <section class="panel panel-default">
          ...
          <div class="panel-body">                    
            ...
            <div class="form-group">
              ...
              <div class="col-sm-9">
                <input type="text" data-type="email" disabled class="form-control parsley-validated" name="email" placeholder="EmailId" value="<?php echo isset($this->data['member_details']) ?  $this->data['member_details']->email : '' ?>">
              </div>
            </div>
            <div class="line line-dashed b-b line-lg pull-in"></div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-9">
                <input type="text" data-type="phone" <?php echo isset($this->data['member_details']->mtn_mobile_number) ? "disabled" : '' ?> class="form-control parsley-validated" name="mtn_mobile_number" placeholder="MTN Account Number" value="<?php echo isset($this->data['member_details']) ?  $this->data['member_details']->mtn_mobile_number : '' ?>">
              </div>
            </div>
            <div class="line line-dashed b-b line-lg pull-in"></div>
            <div class="form-group">
              ...
              <div class="col-sm-9">
                <input type="text" data-type="text" <?php echo isset($this->data['member_details']->mtn_mobile_number) ? "disabled" : '' ?> class="form-control parsley-validated" name="mtn_mobile_name" placeholder="MTN Account Name" value="<?php echo isset($this->data['member_details']) ?  $this->data['member_details']->mtn_mobile_name : '' ?>">
              </div>
            </div>
          </div>
