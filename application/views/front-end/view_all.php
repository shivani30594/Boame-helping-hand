      ...
      <div class="row">
        <div class="col-md-12">
            <div class="page-breadcroumb">
                <p><a href="index.html">Home</a> / Recent News</p>
            </div>
          ...
          <div class="col-md-4 col-sm-6 col-xs-12">
            <div class="featured-news">
              <div class="featured-news-content">
                  <img src="<?php echo ADMIN_NEWS.$value->image?>" alt="">
                  <div class="featured-news-date">
                      <p><?php echo date('d',strtotime($value->created_at));?> <span><?php echo date('F',strtotime($value->created_at));?></span></p>
                  </div>
              </div>
              <div class="featured-news-title">
                  <h2><a href="<?php echo BASE_URL.'single/'.$value->id?>"><?php echo $value->title?></a></h2>
                  <p><?php echo strip_tags($value->description)?></p>
                  <a href="<?php echo BASE_URL.'single/'.$value->id?>" class="readmore">Read More</a>
              </div>
            </div>
          </div>
        <?php endforeach;?>
